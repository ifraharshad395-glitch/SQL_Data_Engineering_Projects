...
-- select job_title_short, count(*) as job_count, min(priority_lvl) as priority_lvl, min(updated_at) as updated_at
...
---if you are going to chase an impossible dream, case one that actually matters -
